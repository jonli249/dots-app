...
const SongItem: React.FC<SongItemProps> = ({ title, artistCredit, _id, geniusData, onClick}) => {
  ...
  return (
    ...
    <Link onClick={onClick} href={`/songs/${_id}`} className="border border-gray-300 rounded shadow-md">
