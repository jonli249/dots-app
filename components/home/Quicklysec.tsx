...
const Quicklysec = () => {
  return (
    <div className="w-full flex flex-col items-center mt-20 md:mt-[95px] 2xl:mt-[108px]">
      <h2 className="text-black px-3 md:px-0 text-lg sm:text-[42px] md:text-[50px] 2xl:text-[70px] text-center leading-normal font-normal">
        Quickly browse through thousands of <br /> Songs, Artists, Songwriters
        and Producers.
      </h2>

      {/* search input with background */}
      <div className="max-w-[800px] 2xl:max-w-[1014px] w-full mx-auto my-6 md:my-10 2xl:my-[80px] px-4 md:px-12 2xl:px-12 h-[120px] sm:h-[210px] bg-[url(/input-bg.png)] bg-center bg-contain 2xl:bg-cover flex items-center justify-center bg-no-repeat">
        <div
