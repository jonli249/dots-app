...
const Hero = () => {
  return (
    <div className="w-full bg-[url(/img/hero-bg.png)] bg-cover bg-center bg-no-repeat h-[70vh] xl:h-[85vh] 2xl:h-screen flex justify-center items-center">
      <div className="flex flex-col items-center max-w-[900px] w-full">
        ...
        {/* swiper section */}
        <div className="w-full max-lg:px-3 max-w-[300px] sm:max-w-[540px] lg:max-w-[787px] relative h-fit">
          {/* white box */}
        ...
        <div className="w-[220px] h-[115px] mt-4 sm:mt-[51px] bg-[url(/img/btn-bg.png)] bg-center bg-cover bg-no-repeat flex items-center justify-center">
          <button
            type="submit"
