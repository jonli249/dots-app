    ...
    <div className="sm:max-w-[266px] w-full mx-auto">
      ...
      <div className="mt-[43px] flex flex-col gap-[14px]">
        {songsTogetherCardData.map((items, index) => (
          <div
            key={index}
            className="w-[266px] cursor-pointer h-[97px] max-sm:mx-auto rounded-lg border border-[#696969] bg-white shadow-[2.089px_4.178px_10.446px_0px_rgba(0,0,0,0.10)] py-[18px] pl-6 flex items-center gap-4"
          >
