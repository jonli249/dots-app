...
function Navbar() {
  ...
  const imageContainerClass = showSearchButton ? "imageContainerWithSearch" : "imageContainerWithoutSearch";
   ...
   <div className="px-5 z-[100]">
        <nav className="w-full mx-auto flex items-center justify-between pt-2 sm:pt-3">
          <Link href="/">
            ...
            <div className={imageContainerClass} style={{ width: '36px', height: '36px' }}>
